...
CAPTION_STYLES: dict[str, dict] = {
    'classic': {},
    'yellow-bold': {'highlight_color': YELLOW, 'color': WHITE, 'outline': {'width': 5, 'color': NAVY},
                    'shadow': True, 'back': BACK_ASS},
    'white-outline': {'highlight_color': WHITE, 'color': SOFT_WHITE, 'outline': {'width': 5, 'color': BLACK},
                      'back': TRANSPARENT_ASS},
    'minimal': {'highlight_color': WHITE, 'color': SOFT_WHITE, 'outline': {'width': 2, 'color': BLACK},
                'weight': 'normal', 'back': TRANSPARENT_ASS},
    'off': {'karaoke': False},
    # ---- gallery presets (the ids the brand studio offers) ----
    'none': {'karaoke': False},
    'clean-karaoke': {},
    'yellow-punch': {'highlight_color': YELLOW, 'color': WHITE, 'outline': {'width': 5, 'color': NAVY},
                     'shadow': True, 'case': 'upper', 'back': BACK_ASS},
    'bold-impact': {'weight': 'black', 'case': 'upper', 'size': 76, 'color': WHITE, 'highlight_color': YELLOW,
                    'outline': {'width': 6, 'color': BLACK}, 'shadow': True, 'back': BACK_ASS,
                    'max_words': 3},
    'boxed-focus': {'color': WHITE, 'highlight_color': YELLOW, 'outline': {'width': 0, 'color': BLACK},
                    'box': {'color': BLACK, 'opacity': 0.75}, 'max_words': 4},
    'color-pop': {'color': WHITE, 'highlight_color': ACCENT, 'emphasis': True, 'weight': 'black',
                  'outline': {'width': 4, 'color': BLACK}, 'back': BACK_ASS},
    'two-line-social': {'color': WHITE, 'highlight_color': YELLOW, 'max_lines': 2, 'max_words': 4,
                        'outline': {'width': 4, 'color': BLACK}, 'back': BACK_ASS},
}
...
STYLE_ALIASES = {
    'default': 'classic', 'clean': 'minimal', 'plain': 'minimal', 'bold': 'yellow-bold',
    'yellow': 'yellow-bold', 'outline': 'white-outline', 'white': 'white-outline',
    'karaoke': 'clean-karaoke', 'boxed': 'boxed-focus', 'impact': 'bold-impact',
    'pop': 'color-pop', 'two-line': 'two-line-social', 'social': 'two-line-social',
    'no captions': 'off', 'none': 'none',
}
...
def style_line(style: dict, layout: str = 'vertical', font_name: str = 'DejaVu Sans') -> str:
    ...
    return (f'Style: Default,{font},{font_size},{primary},{secondary},{outline_colour},{back},'
...
def build_ass(groups: list[list[dict]], layout: str = 'vertical', preset: str = 'classic',
              font_name: str = 'DejaVu Sans', placement=None, style=None,
              speaker_colors: dict | None = None) -> str:
    """
    ...
    for group in groups:
        ...
        for i, w in enumerate(group):
            ...
            parts.append(text)
        events.append(f'Dialogue: 0,{_ass_time(line_start)},{_ass_time(line_end)},Default,,0,0,0,,'
                      f'{head}{_line_text(parts, resolved)}')
    return header + '\n' + '\n'.join(events) + '\n'
